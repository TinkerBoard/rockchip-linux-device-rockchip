...
function build_recovery(){
	...
	rm -f buildroot/output/$RK_CFG_RECOVERY/.config*
	rm -f buildroot/output/$RK_CFG_RECOVERY/.rockchipconfig
...
function build_firmware(){
	rm -f buildroot/output/$RK_CFG_BUILDROOT/.config*
	rm -f buildroot/output/$RK_CFG_BUILDROOT/.rockchipconfig
...
function build_save(){
	...
	#Copy stubs
	yes | .repo/repo/repo manifest -r -o $STUB_PATH/manifest_$RELEASE_NAME.xml
